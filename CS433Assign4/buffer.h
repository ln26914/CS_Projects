...
//initialize variables and buffer size 
 int front, back, size, count; //front/back of the buffer, size of the buffer, and number of items in buffer

//indicate buffer size 5
